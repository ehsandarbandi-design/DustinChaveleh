...
export const home = {
  ...
  neighborhoods: {
    ...
    items: [
      ...
      { name: "The Marina", slug: "marina", description: "Waterfront living with energetic nightlife, young professional buzz, and postcard views of the Golden Gate." },
      { name: "North Beach", slug: "north-beach", description: "San Francisco's \"Little Italy,\" filled with historic cafés, iconic bookstores, and a lively mix of old-school charm and nightlife." },
      ...
      { name: "Duboce Triangle", slug: "duboce-triangle", description: "A tucked-away San Francisco pocket where tree-lined streets, charming Victorians, and easy access to transit meet a calm, central city vibe." },
      ...
      { name: "Embarcadero Waterfront", slug: "embarcadero", description: "San Francisco's iconic waterfront corridor, defined by bay views, Ferry Building energy, and a seamless blend of transit, dining, and open-air city life." },
      { name: "Twin Peaks", slug: "twin-peaks", description: "A dramatic hillside landmark offering some of the best panoramic views in San Francisco, from the Bay to the Pacific, above the city's fog line." },
      { name: "Haight Ashbury", slug: "haight-ashbury", description: "A colorful, counterculture-rooted neighborhood known for its vintage shops, eclectic Victorian homes, and enduring 1960s free-spirited energy." },
      { name: "Noe Valley", slug: "noe-valley", description: "A sunny, quiet residential enclave known for its charming Victorian homes, family-friendly streets, and relaxed village-like feel in the heart of the city." },
      { name: "The Excelsior", slug: "excelsior", description: "Right below Bernal Heights, The Excelsior features McLaren Park to the East, and Geneva Avenue to the south. It is in the SFAR's District 10." },
    ] as Neighborhood[],
...
export type Post = { date: string; dateLabel: string; title: string; href: string; excerpt: string; tags?: string[] };

// Blog posts, newest first (links only — bodies stay on the current site until migrated)
export const posts: Post[] = [
  { date: "2026-08-31", dateLabel: "Aug 31, 2026", title: "San Francisco Property Transfer Taxes 2026 Guide", href: "/blog/san-francisco-transfer-taxes", excerpt: "Real estate transfer taxes are rarely a fun topic to discuss, but they are a closing cost that adds up quickly if you aren't paying attention. In this guide, I break down how the home price you are targeting translates directly into your tax liability, and why crossing specific threshold lines can instantly triple your tax rate and cost you tens of thousands of dollars." },
  { date: "2026-08-19", dateLabel: "Aug 19, 2026", title: "Rent Control in San Francisco", href: "/blog/rent-control-in-san-francisco", excerpt: "The market that makes you want to sell is the market that makes your tenant want to stay. When rents are climbing there is nowhere cheaper for them to go, and when they are finally ready to move, prices have usually softened too. Here is the Rent control 101 for San Francisco sellers." },
  { date: "2026-08-14", dateLabel: "Aug 14, 2026", title: "Ranking the Best Platforms for Home Searching (2026 Guide)", href: "/blog/i0ccwm3gm435y9qc8i31gw5zbbqd88", excerpt: "Thinking about buying a home? Relying on just one app like Zillow or Redfin means you might be missing out on exclusive and \"Coming Soon\" listings. Discover why a multi-app setup—and private MLS access—is essential for seeing the full picture of inventory in today's market." },
  { date: "2026-08-03", dateLabel: "Aug 3, 2026", title: "Tenant Buyout Costs in San Francisco", href: "/blog/tenantbuyouts", excerpt: "Rent buyouts — landlords paying tenants cash to voluntarily give up a rent-controlled unit — are happening in San Francisco at a pace not seen since before the pandemic. Here's the quick version: what's driving it, where it's happening, and what the city does (and doesn't) tell you about the price tag." },
  { date: "2026-07-29", dateLabel: "Jul 29, 2026", title: "Schools in San Francisco", href: "/blog/schools-in-san-francisco", excerpt: "San Francisco is a single unified school district — which means there's no \"good school\" neighborhood to buy into, and moving across the city won't automatically change your kid's assigned school. Here's why the suburban playbook doesn't apply here, and how to plan your home search and school enrollment as two separate timelines." },
  { date: "2026-07-28", dateLabel: "Jul 28, 2026", title: "Home Buyers and Sellers Generational Trends", href: "/blog/home-buyers-and-sellers-generational-trends", excerpt: "This post breaks down key findings from the National Association of REALTORS® (NAR) Generational Trends Report, exploring how younger buyers are navigating today's competitive housing market." },
  { date: "2026-07-24", dateLabel: "Jul 24, 2026", title: "Why Real Estate Deals Fall Through", href: "/blog/why-real-estate-deals-fall-through", excerpt: "Most real estate deals don't die from one big dramatic thing — they die from inspection surprises, financing hiccups, and timing that doesn't line up. Here's the actual breakdown by category and percentage, using the latest 2026 NAR and Redfin data, plus what SF buyers and sellers can do to keep their deal off the list." },
  { date: "2026-07-22", dateLabel: "Jul 22, 2026", title: "Before You Buy in the Sunset, Know Its History", href: "/blog/before-you-buy-in-the-sunset-know-its-history", excerpt: "Ever notice how every block in the Sunset looks like a variation on the same house? That's not a coincidence — it's the legacy of a 1930s building boom that put up two houses a day. Here's the real story behind the stucco, the narrow lots, and the little style flourishes that make each one unique." },
